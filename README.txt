...
NishAnimate is a Java desktop application which will, first, convert audio-synchronized Nishnaabemwin text into animatable markup. The markup will then be used by the application to produce a series of animated images (animated GIFs is the tentative plan) which will display in sync with the audio file.
